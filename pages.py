...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,__LOGO_B64__" alt="VBOX"></div>
      <div><div class="brand-name">VBOX</div><div class="brand-sub">v9.5</div></div>
    </div>
    <h1>ورود به پنل</h1>
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='VBOXKING';document.getElementById('pw').focus()">VBOXKING</span>
    </div>
    <form id="form">
      <div class="field">
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="VBOX"></div>
    <span class="mob-title">VBOX</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img"><img src="data:image/png;base64,__LOGO_B64__" alt="VBOX"></div>
    <div><div class="logo-name">VBOX</div><div class="logo-sub">v9.5</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">VBOX v9.5 · Railway</span>
  ...
  <div class="create-panel">
    <div class="cp-head">
      ...
      <div class="cp-head-text">
        ...
        <div class="cp-head-sub">UUID تصادفی · ساخت سریع کانفیگ نامحدود</div>
      </div>
    </div>
    <div class="cp-body">
      <div class="cp-row">
        ...
        <div class="cp-block">
          <div class="cp-block-label"><i class="ti ti-folders"></i> گروه ساب</div>
          <select class="cp-input-full fs" id="nl-sub"><option value="">— بدون گروه —</option></select>
          <div class="cp-mini-row">
            <input style="display:none" class="cp-input-full" id="nl-exp" type="number" min="0" step="1" placeholder="انقضا (روز) · 0 = نامحدود">
          </div>
      ...
      <div class="cp-block mb16">
        ...
        <div class="cp-quota-inputs">
          <input style="display:none" class="cp-input-full" id="nl-val" type="number" min="0" step="0.1" placeholder="0 = نامحدود">
          <select style="display:none" class="cp-input-full fs" id="nl-unit"><option value="GB">GB</option><option value="MB" selected>MB</option></select>
        </div>
      ...
      <div class="cp-row mb16">
        ...
        <div class="cp-block" style="display:none">
      ...
      <div class="cp-row mb16">
        <div class="cp-block" style="display:none;flex:1">
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانی VBOX</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم VBOX</div>
      </div>
    </div>
    <div class="srv-tiles">
      <a class="srv-tile" href="https://www.youtube.com/@VBOXHUB" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-youtube"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">یوتیوب</div><div class="srv-tile-val">youtube.com/@VBOXHUB</div></div>
      </a>
      ...
      <a class="srv-tile" href="https://t.me/vbox_group" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-users-group"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">گروه تلگرام</div><div class="srv-tile-val">t.me/vbox_group</div></div>
      </a>
      ...
      <a class="srv-tile" href="https://github.com/vboxKing" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-github"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">گیت‌هاب</div><div class="srv-tile-val">github.com/vboxKing</div></div>
      </a>
    </div>
  </div>
</section>
...
<script>
let isDark=localStorage.getItem('vbox-theme')==='dark';
...
function toggleTheme(){isDark=!isDark;localStorage.setItem('vbox-theme',isDark?'dark':'light');applyTheme(isDark)}
applyTheme(isDark);
...
async function createLink(){
  ...
  const ip_limit=0;
  const speed_limit_value=0;
  const speed_limit_unit=document.getElementById('nl-speed-unit').value;
  try{
    const r=await authF('/api/links',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({label,limit_value:0,limit_unit:unit,expires_days:0,note,sub_id,protocol,fingerprint,alpn,port,ip_limit:0,speed_limit_value:0,speed_limit_unit})});
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{LOGO_B64}" alt="VBOX"></div>
      <div><div class="brand-name">VBOX</div><div class="brand-sub">v9.5</div></div>
    </div>
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/Farajian2004f" target="_blank">@Farajian2004f</a> · VBOX v9.5</div>
</div>
<script>
const UUID_KEY='{uuid_key}';
let savedPw='';

let isDark=localStorage.getItem('vbox-pub-theme')==='dark';
function applyTheme(dark){{
  document.documentElement.setAttribute('data-theme',dark?'dark':'light');
  document.getElementById('theme-icon').className='ti '+(dark?'ti-sun':'ti-moon');
}}
function toggleTheme(){{isDark=!isDark;localStorage.setItem('vbox-pub-theme',isDark?'dark':'light');applyTheme(isDark)}}
applyTheme(isDark);
...
function renderContent(d){{
  ...
  window._vboxSubUrl  = subUrl;
  window._vboxSubName = d.name;
  window._vboxLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._vboxSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._vboxSubName + ' — کل گروه', window._vboxSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._vboxLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._vboxLinks[${{i}}].label, window._vboxLinks[${{i}}].vless)">
